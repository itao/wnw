...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'parents_parent_children')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('parent', models.ForeignKey(orm[u'parents.parent'], null=False)),
            ('student', models.ForeignKey(orm[u'students.student'], null=False))
        ))
        db.create_unique(m2m_table_name, ['parent_id', 'student_id'])


    def backwards(self, orm):
        # Deleting model 'Parent'
        db.delete_table(u'parents_parent')

        # Removing M2M table for field children on 'Parent'
        db.delete_table(db.shorten_name(u'parents_parent_children'))
