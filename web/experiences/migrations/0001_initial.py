...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field attending on 'Experience'
        m2m_table_name = db.shorten_name(u'experiences_experience_attending')
        ...
        db.create_unique(m2m_table_name, ['experience_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field attending on 'Experience'
        db.delete_table(db.shorten_name(u'experiences_experience_attending'))
    ...
    models = {
        ...
        u'experiences.experience': {
            ...
            'attending': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accounts.User']", 'symmetrical': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
